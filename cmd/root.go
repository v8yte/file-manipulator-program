...
var rootCmd = &cobra.Command{
	Use:   "file-manipulator-program",
	Short: "File Manipulator Program.",
	Long: `reverse <inputpath> <outputpath>:
...
func init() {
	...
	// rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.file-manipulator-program.yaml)")
